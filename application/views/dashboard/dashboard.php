...
var yArray = [<?php echo $dashboard_yala['all_h'] ?>, <?php echo $dashboard_nara['all_h'] ?>, <?php echo $dashboard_pat['all_h'] ?>];

var layout = {
    title: "ครัวเรือนทั้งหมด <?php echo $dashboard_all['all_h']; ?> ครัวเรือน<br>โรงเรียนทั้งหมด <?php echo $dashboard_all['all_scholl']; ?> โรงเรียน"
};
...
<script>
var xArray = ["ยะลา", "นราธิวาส", "ปัตตานี"];
var yArray = [<?php echo $dashboard_yala['all_district'] ?>, <?php echo $dashboard_nara['all_district'] ?>, <?php echo $dashboard_pat['all_district'] ?>];

var layout = {
    title: "อำเภอทั้งหมด <?php echo $dashboard_all['all_district'] ?> อำเภอ"
};
...
<script>
var xArray = ["ยะลา", "นราธิวาส", "ปัตตานี"];
var yArray = [<?php echo $dashboard_yala['all_moo'] ?>, <?php echo $dashboard_nara['all_moo'] ?>, <?php echo $dashboard_pat['all_moo'] ?>];

var layout = {
    title: "หมู่บ้านทั้งหมด <?php echo $dashboard_all['all_moo'] ?> หมู่บ้าน"
};
