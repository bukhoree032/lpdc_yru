      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row" style="margin-top: 10px;">
              <div class="col-sm-6">
              เหลือกี่ก่อน :<br>
              <input class="form-control" type="text" name="j_t_survive" value="<?php echo $j_t_id; ?>">
              </div>
              <div class="col-sm-6">
              เสียกี่ก่อน :<br>
              <input class="form-control" type="text" name="j_t_not_survive" value="<?php echo $j_t_id; ?>">
              </div>
          </div>
          <br>
          ...
          <div class="row" style="margin-top: 10px;">
              ...
              <input class="form-control" type="text" name="j_t_popular" value="<?php echo $j_t_id; ?>">
              </div>
              <div class="col-sm-6">
              จำนวนเงิน :<br>
              <input class="form-control" type="text" name="j_t_buy" value="<?php echo $j_t_id; ?>">
              </div>
          </div>
          ...
          <div class="row" style="margin-top: 10px;">
              <div class="col-sm-6">
              น้ำหนัก :<br>
              <input class="form-control" type="text" name="j_t_weight" value="<?php echo $j_t_id; ?>">
              </div>
              <div class="col-sm-6">
              ระยะเวลา :<br>
              <input class="form-control" type="text" name="j_t_period" value="<?php echo $j_t_id; ?>">
              </div>
          </div>
          <div class="form-group" style="margin-top: 1%">
              ...
              <div class="row">
              <div class="col-md-12">
                  <textarea class="form-control" name="j_t_annotition" rows="4"><?php echo $j_t_id; ?></textarea>
              </div>
