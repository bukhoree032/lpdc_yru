            ...
            <?php if($value['j_t_occupation'] == '8'){ ?>
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-sm-6">
                                <!-- <button type="button" class="btn btn-block btn-success btn-xs" data-toggle="modal" data-target="#myModal_edit_<?php echo $value['j_t_id'] ?>" style="width: 100%"><i class="fas fa-edit"></i></button> -->
                            </div>
                            <div class="col-sm-6">
