      ...
      <div class="container-fluid">
       <!-- SELECT2 EXAMPLE -->
        <div class="card card-default">
          ...
          <form action="<?php echo site_url("Otop_c/Otop_ubi_c/otop_update_year/"); ?>" method="post"enctype="multipart/form-data">
          <!-- /.card-header -->
            <div class="card-body">
              <div class="row">
                <div class="col-md-2">
                ...
                <?php }else if ($hous->o_ubi_ac_id == '2' || $hous->o_ubi_ac_id == '3' ) {?>
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="e_y_gobbet_sur" value="" placeholder="กิโลกรัม">
                    </div>
                  </div>
                ...
                <?php if ($hous->o_ubi_ac_id != '1') {?>
                  <div class="col-md-2" hidden="hidden">
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="e_y_eat" value="" placeholder="จำนวนกี่ตัว">
                    </div>
                  </div>
                  <?php if ($hous->o_ubi_ac_id == '2' || $hous->o_ubi_ac_id == '3' ) {?>
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="e_y_quantity_sold" value="" placeholder="น้ำหนัก<?php echo $title_in; ?>ต่อเดือน (กิโลกรัม)">
                      </div>
                    </div>
                  <?php }else{ ?>
                    <div class="col-md-3">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" name="e_y_detail"  rows="5"></textarea>
                    </div>
                  </div>
