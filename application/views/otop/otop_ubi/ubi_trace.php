            ...
            <div class="card">
              ...
              <div class="card-header">
                <div class="row">
                  ...
                  <!-- ------------------------model------------------------ -->
                  <form action="<?php echo site_url("Otop_c/Otop_ubi_c/trace_insert/".$oid); ?>" method="post"enctype="multipart/form-data">  
                  ...
                  <!-- ------------------------/model------------------------ -->
                  <div class="col-sm-2" >
                      <button type="button" class="btn btn-block bg-gradient-primary btn-sm"  onclick="window.location='<?php echo site_url("Otop_c/Otop_ubi_c/shop_mushroom/".$oid); ?>'" style="width: 100%">ประวัติการซื้อ</button>
                  </div>
                </div>
                      ...
                      <div class="modal" id="myModal_edit<?php echo $trace->o_ubi_tr_id; ?>">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <!-- Modal body -->
                            <form action="<?php echo site_url("Otop_c/Otop_ubi_c/trace_edit_mushroom/".$oid); ?>" method="post"enctype="multipart/form-data"> 
                            <input type="" hidden="hidden" name="deal" value="<?php echo $trace_row['trace']; ?>">  
                            <input type="" hidden="hidden" name="id" value="<?php echo $trace->o_ubi_tr_id; ?>">                      
                              <div class="modal-body"> 
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" type="text" value="<?php echo $trace->o_ubi_tr_buy; ?>" name="price" >
                                  </div>
                                </div>
                                <div class="row" style="margin-top: 10px;">
                                  <div class="col-sm-3">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" type="text" value="<?php echo $trace->o_ubi_tr_weight; ?>" name="CC" >
                                  </div>
                                </div>
                                <div class="row" style="margin-top: 10px;">
                                  <div class="col-sm-3">
                                ...
                                <div class="col-sm-5">
                                    <input class="form-control" type="text" value="<?php echo $trace->o_ubi_tr_period; ?>" name="period" >
                                  </div>
                                </div>
                                <div class="row" style="margin-top: 10px;">
                                  <div class="col-sm-3">
