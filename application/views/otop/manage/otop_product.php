        ...
        <!-- ----------------------------/รายงาน---------------------------- -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">เพิ่มผลิตภัณฑ์</h3>
              </div>
              <div class="card-header">
                <div class="row">
                  <div class="col-sm-2">
                    <button type="button" class="btn btn-block bg-gradient-primary btn-sm" data-toggle="modal" data-target="#modal-default" style="width: 100%">+ เพิ่มผลิตภัณฑ์</button>
                  </div>
                  <div class="col-sm-2">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th style="width: 80%">ชื่อผลิตภัณฑ์</th>
                    <th style="width: 10%">แก้ไข</th>
                  </tr>
                  </thead>
                  <tbody>
                  <?php $row = 0;
                    foreach ($goalANDpro['pro'] as $pro) { 
                    $row ++;  ?>
                    <tr>
                      <td><?php echo $row; ?></td>
                      <td><?php echo $pro->o_p_name; ?></td>
                      <td>
                        <div class="row">
                          
                          <div class="col-sm-12">
                            <button type="button" class="btn btn-block btn-success btn-xs"  data-toggle="modal" data-target="#modal-default<?php echo $pro->o_p_id; ?>" ><i class="fas fa-edit"></i></button>
                          </div>
                    ...
                    <!-- ------------modal add product ------------------------ -->
                        ...
                        <div class="modal-dialog">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <h4 class="modal-title">ผลิตภัณฑ์ใหม่</h4>
                              ...
                              <form id="form_product_insert" action="<?php echo site_url("Otop_c/Manage_otop_c/product_insert/"); ?>" method="post"enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                          <div class="customer_records">
                                             <div class="row">
                                                <div class="col-md-8">
                                                   <input class="form-control" name="product_name[]" type="text"  placeholder="ชื่อผลิตภัณฑ์">
                                                </div>
                                                <!-- <div class="col-md-4">
                                                   <a class="extra-fields-customer" href="#">เพิ่มผลิตภัณฑ์</a>
                                                </div> -->
                                             </div>
                                          </div>
                     ...
                     <!-- /.modal -->
                      <!-- ------------modal add product ------------------------ -->
                     <div class="modal fade" id="modal-default<?php echo $pro->o_p_id; ?>">
                        <div class="modal-dialog">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <h4 class="modal-title">แก้ไขชื่อผลิตภัณฑ์</h4>
                                 <button type="button" class="close" name="" data-dismiss="modal" aria-label="Close">
                                 <span aria-hidden="true">&times;</span>
                                 </button>
                              </div>
                              <!-- <form id="form_product_insert" method="post"enctype="multipart/form-data"> -->
                              <form id="form_product_insert" action="<?php echo site_url("Otop_c/Manage_otop_c/product_update/".$pro->o_p_id); ?>" method="post"enctype="multipart/form-data">
                                 <div class="modal-body">
                                    <p>ผลิตภัณฑ์</p>
                                    <div class="row">
                                       <div class="col-md-12">
                                          <div class="customer_records">
                                             <div class="row">
                                                <div class="col-md-8">
                                                   <input class="form-control" name="product_name" type="text"  value="<?php echo $pro->o_p_name; ?>" placeholder="ชื่อผลิตภัณฑ์">
                                                </div>
                                             </div>
                                          </div>
                                          <div class="customer_records_dynamic"></div>
                     ...
                     <div class="modal fade" id="modal-default">
                        <div class="modal-dialog">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <h4 class="modal-title">การดำเนินงานพัฒนา</h4>
                                    ...
                                    <div class="row">
                                       <div class="col-md-12">
                                          <div class="customer_records1">
                                             <div class="row">
                                                <div class="col-md-8">
                                                   <input class="form-control" name="goal_name[]" type="text"  placeholder="การดำเนินงานพัฒนา">
                                                </div>
                                                <div class="col-md-4">
                                                   <a class="extra-fields-customer1" href="#">เพิ่มการดำเนินงาน</a>
                                                </div>
                                             </div>
                                          </div>
