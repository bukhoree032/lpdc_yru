...
<html lang="en">
    <head>        
        ...
        <!-- CSS INCLUDE -->        
        <link rel="stylesheet" type="text/css" id="theme" href="<?php echo base_url('/lpdc_admin111/') ?>css/theme-default.css"/>
        <!-- EOF CSS INCLUDE -->                                    
    </head>
    <body>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-horizontal">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><strong>เพิ่มกิจกรรมใหม่</strong></h3>
                                    ...
                                    <div class="panel-body form-group-separated">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12"> 
                                                <form id="form_insert" enctype="multipart/form-data" action="<?php echo site_url("Admin_c/Project_c/activity_insert") ?>" method="post" >
                                                    <div class="row">
                                                        <div class="col-md-12" style="margin-left: -10px">
                                                            <div class="customer_records">
                                                                ...
                                                                <input name="likn[]" type="text" placeholder="URL">
