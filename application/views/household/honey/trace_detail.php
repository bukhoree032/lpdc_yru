            ...
            <div class="row">
                  ...
                  <!-- <?php $i = "0";
                    foreach ($trace_dtail["hold"] as $hold) { 
                      $i ++;
                      if ($i == "1") { ?>
                        <div class="col-sm-2"><button type="button" class="btn btn-block bg-gradient-primary btn-sm" style="width: 100%" onclick="window.location='<?php echo site_url("Household_c/Honey_c/trace/".$hold->h_id); ?>'">< ย้อนกลับ</button>
                        </div>
                      <?php }else{
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php foreach ($trace_dtail["trace"] as $trace) { ?>
                        <td><?php echo $trace->h_tr_date; ?></td>
                      <?php } ?>
                    </tr>
                    <tr>
                      <td><b>ช่วยเหลือ</b></td>
                      <?php foreach ($trace_dtail["trace"] as $trace) { ?>
                        <td>ครั้งที่ <?php echo $trace->h_tr_sh_id; ?></td>
                      <?php } ?>
                    ...
                    <tr>
                      <td><b>ติดตาม</b></td>
                      <?php foreach ($trace_dtail["trace"] as $trace) { ?>
                        <td>ครั้งที่ <?php echo $trace->h_tr_row; ?></td>
                      <?php } ?>
                      
                    </tr>
                    <tr>
                      <td><b>ลังผึ้งที่ได้รับ</b></td>
                      <?php foreach ($trace_dtail["honey"] as $honey) { ?>
                        <td><?php echo $honey->h_sh_gobbet; ?> ลัง</td>
                      <?php } ?>
                      
                    </tr>
                    <tr>
                      <td><b>ลังผึ้งที่ขยาย</b></td>
                      <?php foreach ($trace_dtail["trace"] as $trace) { ?>
                    ...
                    <tr>
                      ...
                      <?php foreach ($trace_dtail["trace"] as $trace) { ?>
                        <td><?php echo $trace->h_tr_up; ?> ลัง</td>
                      <?php } ?>
