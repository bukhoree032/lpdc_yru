                     ...
                     <div class="info-box" style="background-color: #26cae4; color: #fff">
                      ...
                      <div class="info-box-content">
                        ...
                        <span class="progress-description">
                           <span class="progress-description" >
                              <?php echo $hold_dashboard['all_parish'] ;?> ตำบล  <?php echo $hold_dashboard['all_district'] ;?> อำเภอ
                           </span>
                         </span>
                      </div>
                      <!-- /.info-box-content -->
                  ...
                  <div class="col-md-12 col-sm-6 col-12">
                       <div class="info-box" style="background-color: #26cae4; color: #fff">
                        ...
                        <div class="info-box-content">
                          ...
                          <span class="progress-description">
                                <?php echo $hold_dashboard['all_parish62'] ;?> ตำบล  <?php echo $hold_dashboard['all_district62'] ;?> อำเภอ
                           </span>
                        </div>
                        <!-- /.info-box-content -->
                     </div>
                ...
                <div class="col-md-12 col-sm-6 col-12">
                     <div class="info-box" style="background-color: #3ad05c; color: #fff">
                      ...
                      <div class="info-box-content">
                         ...
                         <span class="progress-description">
                              <?php echo $hold_dashboard['nara_parish'] ;?> ตำบล  <?php echo $hold_dashboard['nara_district'] ;?> อำเภอ
                         </span>
                      </div>
                      <!-- /.info-box-content -->
                   </div>
                  ...
                  <div class="col-md-12 col-sm-6 col-12">
                       <div class="info-box" style="background-color: #3ad05c; color: #fff">
                        ...
                        <div class="info-box-content">
                           ...
                           <span class="progress-description">
                                <?php echo $hold_dashboard['nara_parish62'] ;?> ตำบล  <?php echo $hold_dashboard['nara_district62'] ;?> อำเภอ
                           </span>
                        </div>
                        <!-- /.info-box-content -->
                     </div>
                ...
                <div class="col-md-12 col-sm-6 col-12">
                     <div class="info-box" style="background-color: #ffc107; color: #fff">
                      ...
                      <div class="info-box-content" style="color: #fff">
                         ...
                         <span class="progress-description">
                              <?php echo $hold_dashboard['yala_parish'] ;?> ตำบล  <?php echo $hold_dashboard['yala_district'] ;?> อำเภอ
                         </span>
                      </div>
                      <!-- /.info-box-content -->
                   </div>
                  ...
                  <div class="col-md-12 col-sm-6 col-12">
                       <div class="info-box" style="background-color: #ffc107; color: #fff">
                        ...
                        <div class="info-box-content" style="color: #fff">
                           ...
                           <span class="progress-description">
                                <?php echo $hold_dashboard['yala_parish62'] ;?> ตำบล  <?php echo $hold_dashboard['yala_district62'] ;?> อำเภอ
                           </span>
                        </div>
                        <!-- /.info-box-content -->
                     </div>
                ...
                <div class="col-md-12 col-sm-6 col-12">
                     <div class="info-box" style="background-color: #7f8991; color: #fff">
                      ...
                      <div class="info-box-content">
                         ...
                         <span class="progress-description">
                              <?php echo $hold_dashboard['pat_parish'] ;?> ตำบล  <?php echo $hold_dashboard['pat_district'] ;?> อำเภอ
                         </span>
                      </div>
                      <!-- /.info-box-content -->
                   </div>
                  ...
                  <div class="col-md-12 col-sm-6 col-12">
                       <div class="info-box" style="background-color: #7f8991; color: #fff">
                        ...
                        <div class="info-box-content">
                           ...
                           <span class="progress-description">
                                <?php echo $hold_dashboard['pat_parish62'] ;?> ตำบล  <?php echo $hold_dashboard['pat_district62'] ;?> อำเภอ
                           </span>
                        </div>
                        <!-- /.info-box-content -->
                     </div>
