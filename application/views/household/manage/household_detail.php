        ...
        <div class="row mb-2">
          <div class="col-sm-8">
            <div class="row">
              ...
              <div class="col-sm-2"><button type="button" class="btn btn-block bg-gradient-primary btn-sm" style="width: 100%" onclick="window.location='<?php echo site_url("Household_c/Manage_c/househole_data_bin"); ?>'">< ย้อนกลับ</button>
              </div>
            <?php }else{ ?>
       ...
       <div class="card" style="padding: 10px">
              ...
              <div class="card-body p-0">
                ...
                <?php foreach ($househole as $hous) { ?>
                  <div class="col-sm-2"><button type="button" class="btn btn-block bg-gradient-primary btn-sm" style="width: 100%" onclick="window.location='<?php echo site_url("Household_c/Manage_c/househole_edit/".$hous->h_id) ?>'">แก้ไขข้อมูลส่วนตัว</button>
                  </div>
                <?php } ?>
                            ...
                            <div class="row">
                                <div class="col-sm-2" style="margin-left: 10px">
                                    <a href="" data-toggle="lightbox" data-title="sample 1 - white" data-gallery="gallery">
                                      <img src="<?php echo base_url('/imag/') ?><?php echo $profile->im_name; ?>" class="img-fluid mb-2" alt="white sample"/>
                                    </a>
                                </div>
                            </div>

                            <div class="col-sm-3"><button type="button" class="btn btn-block bg-gradient-primary btn-sm" style="width: 70%" onclick="window.location='<?php echo site_url("Household_c/Manage_c/eva_add/".$hous->h_id) ?>'">แก้ไขรูปประจำตัว</button>
                            </div>
                          <?php } ?>
                        <?php }else{ ?>
                          <div class="col-sm-3"><button type="button" class="btn btn-block bg-gradient-primary btn-sm" style="width: 70%" onclick="window.location='<?php echo site_url("Household_c/Manage_c/eva_add/".$hous->h_id) ?>'">เพิ่มรูปประจำตัว</button>
                          </div>
                        <?php } ?>
                      </td>
                    </tr>
                      ...
                      <tr>
                        ...
                        <?php if ($hous->h_latitude) { ?>
                          ...
                          <td>
                            <div class="row">
                              <div class="col-sm-3">
                                ละติจูด : <?php echo $hous->h_latitude; ?> , ลองจิจูด : <?php echo $hous->h_longitude; ?> 
                              </div>
                              <div class="col-sm-1">
                                <button type="button" class="btn btn-block btn-primary btn-xs" onclick="window.location='http://www.google.com/maps/place/<?php echo $hous->h_latitude; ?>,<?php echo $hous->h_longitude; ?>'">นำทาง
                                </button>
                              </div>
                            </div>
                            <div id="demo">
                              <br>
                              <iframe src="https://maps.google.com/maps?q=<?php echo $hous->h_latitude; ?>,<?php echo $hous->h_longitude; ?>&hl=es;z=14&amp;output=embed" style="height: 300px"></iframe>
                              <!-- <iframe src = 'https://maps.google.com/maps?q="+ lat +","+ long +"&hl=es;z=14&amp;output=embed" style='height: 300px'></iframe> -->
                           </div>
                           <div class="col-sm-5"><button type="button" class="btn btn-block bg-gradient-primary btn-sm" style="width: 70%" onclick="window.location='<?php echo site_url("Household_c/Manage_c/eva_add/".$hous->h_id) ?>'">แก้ไขพิกัด/ปักหมุด</button>
                            </div>
                        </td>
                        <?php }else{ ?>
                          <td> 
                            <div class="col-sm-3"><button type="button" class="btn btn-block bg-gradient-primary btn-sm" style="width: 70%" onclick="window.location='<?php echo site_url("Household_c/Manage_c/eva_add/".$hous->h_id) ?>'">เพิ่มพิกัด/ปักหมุด</button>
                            </div>
                          </td>
                        <?php } ?>
                      </tr>
