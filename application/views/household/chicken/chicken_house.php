            ...
            <div class="card">
              <div class="card-header">
                  <h3 class="card-title">เลี้ยงไก่เบตง</h3>
              </div>
              <div class="card-header">
              ...
              <!-- ---------------------------------ค้นหา------------------------- -->
              <div class="card-header">
                <form action="<?php echo site_url("Household_c/Chicken_c/chicken_search/".$acid); ?>" method="post"enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-sm-2">
                        <select class="form-control select2bs4" name="s_year" style="width: 100%;">
                          <?php if ($this->session->userdata('chicken_search_year')) {
                            $session_year = $this->session->userdata('chicken_search_year'); ?>
                    ...
                    <div class="col-sm-2">
                      <select class="form-control select2bs4" name="s_pro" style="width: 100%;">
                        <?php if ($this->session->userdata('chicken_search_pro')) { 
                          $session_pro = $this->session->userdata('chicken_search_pro'); ?>
                        ...
                        <?php if (!$this->session->userdata('login') == '') { ?>
                          <td>
                            <div class="row">
                              ...
                              <div class="col-sm-2">
                                <form action="<?php echo site_url("Household_c/Chicken_c/househole_edit/".$hous->h_id); ?>" method="post"enctype="multipart/form-data">
