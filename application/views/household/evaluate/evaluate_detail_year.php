       ...
       <div class="card" style="padding: 10px">
              ...
              <div class="card-body p-0">
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    <?php foreach ($househole_year as $househole_year1) { ?>
                    <tr>
                    ...
                    <?php foreach ($househole as $hous) { ?>
                      ...
                      <?php 
                        if ($hous->h_occupation == '8') {
                          $title_initials = "ไก่";
                          $title_in = "ตัว";
                          $title = "ตาย";
                        }else if ($hous->h_occupation == '10') {
                          $title_initials = "เห็ด";
                          $title_in = "ก่อน";
                          $title = "เสีย";
                        }else if ($hous->h_occupation == '9') {
                          $title_initials = "รังผึ้ง";
                          $title_in = "รัง";
                          $title = "เสีย";
                        }else if ($hous->h_occupation == '6') {
                          $title_initials = "ชิ้นงาน";
                          $title_in = "ชิ้นงาน";
                          $title = "เสีย";
                        }else if ($hous->h_occupation == '5') {
                          $title_initials = "ชิ้นงาน";
                          $title_in = "ชิ้นงาน";
                          $title = "เสีย";
                        }
                    ...
                    foreach ($househole_year as $househole_year) {
                      if ($hous->h_occupation == '6') { ?>
                        <tr>
                          <td><b>ผลิตได้</b></td>
                      ...
                      <?php }else if ($hous->h_occupation == '6') {
                      ...
                      <tr>
                        <td><b>อาชีพที่เลือก</b></td>
                        <td><?php echo $househole_year->ac_name; ?> (<?php echo $househole_year->ac_initials; ?>)</td>
                      </tr>
