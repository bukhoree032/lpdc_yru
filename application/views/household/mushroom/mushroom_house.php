            ...
            <div class="card">
              <div class="card-header">
                  <h3 class="card-title">เพาะเห็ด</h3>
              </div>
              <div class="card-header">
              ...
              <!-- ---------------------------------ค้นหา------------------------- -->
              <div class="card-header">
                <form action="<?php echo site_url("Household_c/Mushroom_c/mushroom_search/".$acid); ?>" method="post"enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-sm-2">
                        <select class="form-control select2bs4" name="s_year" style="width: 100%;">
                          <?php if ($this->session->userdata('mushroom_search_year')) {
                            $session_year = $this->session->userdata('mushroom_search_year'); ?>
                    ...
                    <div class="col-sm-2">
                      <select class="form-control select2bs4" name="s_pro" style="width: 100%;">
                          <?php if ($this->session->userdata('mushroom_search_pro')) { 
                          $session_pro = $this->session->userdata('mushroom_search_pro'); ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="row">
                            <div class="col-sm-5">
                              <?php if ($hous->id) { ?>
                               <button type="button" class="btn btn-block btn-primary btn-xs" onclick="window.location='<?php echo site_url("Household_c/Mushroom_c/mushroom_deal/".$hous->h_id); ?>'">ช่วยเหลือ</button>
                              <?php }else{ ?>
                               <button type="button" class="btn btn-block btn-danger btn-xs" onclick="window.location='<?php echo site_url("Household_c/Mushroom_c/mushroom_deal/".$hous->h_id); ?>'">ช่วยเหลือ</button>
                              <?php } ?>
                            </div>
                            <div class="col-sm-5">
                              <form action="<?php echo site_url("Household_c/Mushroom_c/mushroom_trace/".$hous->h_id); ?>" method="post"enctype="multipart/form-data">
                            ...
                            <div class="col-sm-2">
                              <form action="<?php echo site_url("Household_c/Mushroom_c/househole_edit/".$hous->h_id); ?>" method="post"enctype="multipart/form-data">
