	...
	{	
		...
		if ($check != "1") {
			...
			$quer_code = $this->db->query(" SELECT *
											...
											LEFT JOIN provinces ON provinces.pro_id = household.h_province
											LEFT JOIN activity ON activity.ac_id = household.h_occupation
											WHERE household.h_row_budget $year '$h_row_budget' AND  household.h_province $pro1 '$pro' AND  household.h_occupation $acti1 '$acti' AND NOT household.h_status_bin = '2' ORDER BY h_id DESC
										  ");
			return $quer_code->result();
		}
	}
