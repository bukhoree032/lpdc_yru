...
class Evaluate_c extends CI_Controller {
	...
	public function eva_h_year($h_id)
	{
		$provinces['provinces']=$this->Manage_m->manage_provinces();
		$househole['househole']=$this->Manage_m->manage_detail($h_id);
	    // echo json_encode($househole['househole']);
		...
		$this->load->view('head');
		$this->load->view('page',$provinces);
		$this->load->view('household/evaluate/evaluate_year',$househole);
	}


	public function eva_detail_year($h_id)
	{
		$provinces['provinces']=$this->Manage_m->manage_provinces();
		$househole['househole']=$this->Manage_m->manage_detail($h_id);
		$househole_year['househole_year']=$this->Manage_m->manage_detail_year($h_id);
	    // echo json_encode($househole['househole']);
		$activity_nav['activity_nav']=$this->Manage_m->activity_nav();

		$this->load->view('page',$activity_nav);
		$this->load->view('head',$househole_year);
		$this->load->view('page',$provinces);
		$this->load->view('household/evaluate/evaluate_detail_year',$househole);
	}

	public function eva_detail_year_edit($h_id)
	{
		$provinces['provinces']=$this->Manage_m->manage_provinces();
		$househole['househole']=$this->Manage_m->manage_detail($h_id);
		$househole_year['househole_year']=$this->Manage_m->manage_detail_year($h_id);
		...
		$this->load->view('head',$househole_year);
		$this->load->view('page',$provinces);
		$this->load->view('household/evaluate/evaluate_year_edit',$househole);
	}

	public function househole_update_year()
	{
		$h_id = $this->input->post('h_id');

		$househole_up['househole_up']=$this->Evaluate_m->eva_insert_year();
		$househole['househole']=$this->Manage_m->manage_detail($h_id);
		$manage_detail_imag['manage_detail_imag']=$this->Manage_m->manage_detail_imag($h_id);
		$activity_nav['activity_nav']=$this->Manage_m->activity_nav();
		$hid['hid']=$this->Evaluate_m->eva_id($h_id);
		...
		$this->load->view('page',$activity_nav);
		$this->load->view('head',$manage_detail_imag);
		$this->load->view('household/evaluate/url_year',$hid);
	}

	public function househole_ediy_update_year()
	{
		$h_id = $this->input->post('h_id');
		$e_y_id = $this->input->post('e_y_id');

		$househole_up['househole_up']=$this->Evaluate_m->eva_update_year($e_y_id);
		$househole['househole']=$this->Manage_m->manage_detail($h_id);
		$manage_detail_imag['manage_detail_imag']=$this->Manage_m->manage_detail_imag($h_id);
		$activity_nav['activity_nav']=$this->Manage_m->activity_nav();
		$hid['hid']=$this->Evaluate_m->eva_id($h_id);
	...
	public function eva_add_year($h_id)
	{
		...
		$this->load->view('page',$activity_nav);
		$this->load->view('head',$eva_add);
		$this->load->view('household/evaluate/evaluate_detail_add_year',$manage_detail_imag);
	}
}
